package com.woldier.auth.databases.datasource;
...
import com.woldier.auth.base.id.IdGenerate;
import com.woldier.auth.base.id.SnowflakeIdGenerate;
import com.woldier.auth.databases.mybatis.typehandler.FullLikeTypeHandler;
import com.woldier.auth.databases.mybatis.typehandler.LeftLikeTypeHandler;
import com.woldier.auth.databases.mybatis.typehandler.RightLikeTypeHandler;
import com.woldier.auth.databases.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "wd-auth.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
